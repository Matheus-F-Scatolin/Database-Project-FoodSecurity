...
This project is licensed under the MIT License. See the [LICENSE](LICENSE) file for details (you may need to create this file and add the MIT license text).

## Acknowledgements

*   Data provided by [FAOSTAT](https://www.fao.org/faostat/en/#home).
*   This project was developed as part of the MC536 course at [Your University Name - e.g., University of Campinas (Unicamp)].
